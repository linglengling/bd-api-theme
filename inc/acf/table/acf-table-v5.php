...
class acf_field_table extends acf_field {
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		// register & include JS
		wp_enqueue_script( 'acf-input-table', get_template_directory_uri() . '/inc/acf/table/js/input-v5.js', array( 'jquery', 'acf-input' ), $this->settings['version'], true );

		// register & include CSS
		wp_register_style( 'acf-input-table',  get_template_directory_uri() . '/inc/acf/table/css/input.css', array( 'acf-input' ), $this->settings['version'] );
