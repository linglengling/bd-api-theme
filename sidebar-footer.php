...
<div class="footer-widgets-wrapper">
    ...
    <div class="footer-content">
        ...
        <div class="footer-dvert">
            <div class="footer-advertBackground"></div>
            <div class="footerAdvertGambling footer-advertGambling">
                <!--<div class="footer-ambleResponsiblyLink">Gamble Responsibly. <a href="http://www.gamblingtherapy.org/" target="_blank">Gambling Therapy</a>. 18+</div>-->
            </div>
        </div>
        <div class="footer-copyright"><div class="footer-copyrightText">
                            Copyright © 2018-2022 24hscore.com 
                       </div><div class="footer-privacy footer-privacy--shield privacySettings">
                                    <span class="footer-privacyButton">
