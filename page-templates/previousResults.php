...
<div class='fixtures_roundTitle'>Latest Results</div>
                                   <?php
                                    ...
                                    <div class="game-card_container">
                                     <div class="drawer-container">
                                         ...
                                         <a class="game-card_game_card_link" href="<?php echo $link; ?>">
                                             ...
                                             <img alt title decoding="async" src="https://d32w7lk5b0fi14.cloudfront.net/scorecenter/images/team-logo/60x60/<?php echo $eventList['homeId'];?>.png" class="game-card-competitor_logo homeTeam_logo" />
                                             <?php
                                             ...
                                             ?>
                                             <img alt title decoding="async" src="https://d32w7lk5b0fi14.cloudfront.net/scorecenter/images/team-logo/60x60/<?php echo $eventList['awayId'];?>.png" class="game-card-competitor_logo awayTeam_logo" />
